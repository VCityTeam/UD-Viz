...
export class AllWidget {
  ...
  addWidgetAuthentication(configServer, pathAuthenticationIcon) {
    const initAuthenticationFrame = (pathAuthenticationIcon) => {
    ...
    const updateAuthenticationFrame = () => {
      ...
      console.log('update authentication frame');
    ...
    // intialize ui
    initAuthenticationFrame(pathAuthenticationIcon);
