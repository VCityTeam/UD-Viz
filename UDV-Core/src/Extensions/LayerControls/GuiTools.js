...
// import * as dat from './dat.gui/dat.gui.min.js';
import * as dat from './dat.gui/dat.gui.min.js'
...
export function GuiTools(domId, view, viewerDiv, itowns) {
    var width = 245;
    this.itowns = itowns;
...
GuiTools.prototype.addImageryLayersGUI = function addImageryLayersGUI(layers) {
    var i;
    var seq = this.itowns.ImageryLayers.getColorLayersIdOrderedBySequence(layers);
